...
export default function DashboardPage() {
  ...
  const getStatus = () => {
    ...
    if (vitals.hr > 185 || vitals.spo2 < 90 || vitals.fatigue.overall > 90)
      return {
        text: "Critical Load",
        color: "var(--danger)",
        bg: "rgba(239, 68, 68, 0.05)",
      };
    if (vitals.hr > 165 || vitals.spo2 < 94 || vitals.fatigue.overall > 70)
      return {
        text: "High Strain",
        color: "var(--warning)",
        ...
        <div className="dash-col-main">
          <div className="card graph-card">
            <div className="graph-header">
              ...
              <h2
                className="retro-heading graph-val"
          ...
          >
            ...
            <div className="fatigue-list">
              ...
              <MiniFatigueGraph
                ...
                dataKey="muscle"
                color="var(--warning)"
                value={vitals.fatigue.muscle}
              />
              <MiniFatigueGraph
                title="Lower Body Stress"
                data={history}
                dataKey="leg"
                color="var(--primary)"
                value={vitals.fatigue.leg}
              />
            </div>
          </div>
